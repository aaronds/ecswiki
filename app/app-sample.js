...
exports.validate_doc_update = function (newDoc, oldDoc) {
	...
	ecc = (function(window,undefined) {/** @fileOverview Javascript cryptography implementation.
	 *
	...
	*/
	...
	if (compareSignature(newDoc.signature, oldDoc.signature) == 0) {
		throw new Error("Rejecting unchanged singature");
	}
	...
	if (!ecc.verify(oldDoc.publicKey, newDoc.signature, signText)) {
